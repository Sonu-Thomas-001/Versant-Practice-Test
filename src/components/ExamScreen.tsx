      ...
      <div className="w-full max-w-3xl space-y-6">
        ...
        <div className="flex justify-between pt-4 mt-8 bg-white border-t border-gray-100 py-4 px-2 flex-wrap gap-2">
           <div className="w-full sm:w-auto">
             {currentQuestion.type !== 'repeat' && currentQuestion.type !== 'build' && currentQuestion.type !== 'completion' && currentQuestion.type !== 'dictation' && currentQuestion.type !== 'reconstruction' && (
